<template>
	<view class="evan-form-show">
		<evan-form ref="form" :model="sendform">
			<evan-form-item label="维修人员" prop="dealuser">
			...
			<evan-form-item label="备注" label-position="top">
				<textarea class="form-input textarea" placeholder-class="form-input-placeholder" v-model="sendform.note" placeholder="请填写派单备注" />
			</evan-form-item>
